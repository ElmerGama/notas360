...
return [
    ...
    |
    */
    'name' => 'Unidad Educativa Guadalupana',
    ...
    */
    ...
    'menu' => [
        [
            'title' => 'Dashboard',
            'path'  => '/',
            'icon'  => 'fas fa-tachometer-alt',  // Icono de FontAwesome
        ],
        [
            ...
            'children' => [
                [
                    'title' => 'Gestiones',
                    'path'  => 'gestiones',  // Ruta que lleva al controlador
                ],
                [
                    'title' => 'Periodos',
                    'path'  => 'periodos',
